...
In this workshop you will download and start Jenkins, create a job for a ruby project
which uses git, set up ci_reporter gem for stats and configure email notifications
about failures in builds.

Start here: http://titas.github.com/jenkins-workshop
